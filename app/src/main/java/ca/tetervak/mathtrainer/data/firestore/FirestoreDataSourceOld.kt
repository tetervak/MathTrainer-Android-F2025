...
//@Singleton
//class FirestoreDataSourceOld @Inject constructor(
...
//        .collection("problems")
//
//    fun getUserQuizzesFlow(): Flow<List<QuizDoc>> = callbackFlow {
...
//                QuizDoc.fromMap(quizId = doc.id, data = doc.data!!)
//            }
//            trySend(quizzes)
//        }
//        awaitClose {
...
//    }
//
//    fun getQuizByIdFlow(quizId: String): Flow<QuizDoc?> = callbackFlow {
...
//                return@addSnapshotListener
//            }
//            trySend(QuizDoc.fromMap(quizId = quizId, data = snapshot.data!!))
//        }
//        awaitClose {
//            listenerRegistration.remove()
//        }
...
//            QuizDoc.fromMap(quizId = quizId, data = docSnap.data!!)
//        } else null
//    }
//
//    fun getQuizProblemsFlow(quizId: String): Flow<List<FdsProblem>> = callbackFlow {
...
//                FdsProblem.fromMap(problemId = doc.id, data = doc.data!!)
//            }
//            trySend(problems)
//        }
//        awaitClose {
...
//    }
//
//    suspend fun getProblemById(problemId: String): FdsProblem? {
//        val docSnap: DocumentSnapshot =
//            problemsCollection().document(problemId).get().await()
//        return if (docSnap.exists()) {
//            FdsProblem.fromMap(problemId = problemId, data = docSnap.data!!)
//        } else null
//    }
//
//    fun getProblemByIdFlow(problemId: String): Flow<FdsProblem?> = callbackFlow {
...
//                return@addSnapshotListener
//            }
//            trySend(FdsProblem.fromMap(problemId = problemId, data = snapshot.data!!))
//        }
//        awaitClose {
//            listenerRegistration.remove()
//        }
//    }
//
//    suspend fun getQuizProblemByNumber(quizId: String, problemNumber: Int): FdsProblem? {
//        val query = problemsCollection()
//            .whereEqualTo("quizId", quizId)
...
//        return if (!querySnapshot.isEmpty) {
//            val docSnapshot = querySnapshot.documents.first()
//            FdsProblem.fromMap(problemId = docSnapshot.id, data = docSnapshot.data!!)
//        } else null
//    }
//
//    suspend fun insertQuiz(quiz: QuizDoc): String {
...
//    }
//
//    suspend fun addQuizWithProblems(problems: List<FdsProblem>): String {
